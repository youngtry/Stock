...
//1.代理传值
@protocol AuthCountryCodeControllerDelegate <NSObject>
...
@interface AuthCountryCodeController : BaseViewController

//代理
@property (nonatomic, assign) id<AuthCountryCodeControllerDelegate> deleagete;
