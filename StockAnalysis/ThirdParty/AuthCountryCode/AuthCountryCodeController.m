...
@interface AuthCountryCodeController()<UITableViewDataSource,UITableViewDelegate,UISearchBarDelegate,UISearchDisplayDelegate>{
    //国际代码主tableview
...
@interface AuthCountryCodeController ()

@end

@implementation AuthCountryCodeController
...
-(void)creatSubviews{
    ...
    NSString *plistPathCH = [[NSBundle mainBundle] pathForResource:@"sortedAuthChnames" ofType:@"plist"];
    NSString *plistPathEN = [[NSBundle mainBundle] pathForResource:@"sortedAuthEnames" ofType:@"plist"];
